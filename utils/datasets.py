...
def load_wine_dataset():
    ...
    file_path = 'data/Wine.xlsx'
    dataset = pd.read_excel(file_path)
    return dataset

def load_mall_customer_dataset():
    # Function to load the preprocessed dataset
    file_path = 'data/Mall_Customers.xlsx'
    dataset = pd.read_excel(file_path)
    return dataset
...
def load_wild_blueberry_yield_dataset():
    # Function to load the preprocessed dataset
    file_path = 'data/WildBlueberry_Yield.xlsx'
    dataset = pd.read_excel(file_path)
    return dataset

def load_sleep_health_lifestyle_dataset():
    # Function to load the preprocessed dataset
    file_path = 'data/Sleep_Health_Lifestyle.xlsx'
    dataset = pd.read_excel(file_path)
    return dataset

def load_automobile_customer_segmentation_dataset():
    # Function to load the preprocessed dataset
    file_path = 'data/Automobile_Customer_Segmentation.xlsx'
    dataset = pd.read_excel(file_path)
    return dataset
